...
LOGIN_REDIRECT_URL = '/'  # Redirigir al índice del catálogo después de iniciar sesión
LOGOUT_REDIRECT_URL = '/'  # Redirigir al índice del catálogo después de cerrar sesión